    ...
    >
      ...
      >
        {images.map((src, i) => (
          <div
            key={`${src}-${i}`}
            className="shrink-0 w-[min(280px,85vw)] sm:w-[320px] rounded-xl overflow-hidden border-2 border-gold-400/70 bg-card shadow-lg shadow-gold-500/25 [@media(hover:hover)]:hover:border-gold-400 [@media(hover:hover)]:hover:shadow-gold-500/40 transition-shadow duration-300"
          >
            <div className="relative w-full h-[380px] sm:h-[440px] bg-card">
              <Image
                src={src}
    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl">
          ...
          <div
            className="mt-3 h-1 w-16 rounded-full bg-gold-500"
            aria-hidden="true"
          />
